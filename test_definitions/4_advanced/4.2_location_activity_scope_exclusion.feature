# ATI test 23, variant with activity-scope exclusion
# TODO Annex 4 specifies location without this exclusion - decide whether to keep this variant
@iati-activity
Feature: Location (sub-national, with activity-scope exclusion)
